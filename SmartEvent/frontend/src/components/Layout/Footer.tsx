        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Simplifying event management and registration for businesses and individuals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg
                  className="h-6 w-6 text-primary-400 mr-2 flex-shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:info@smartevent.com"
                  className="text-gray-400 hover:text-primary-400 transition-colors"
                >
                  info@smartevent.com
                </a>
